...
\begin{frame}{A Researcher's Heuristic}
  ...
  \begin{tikzpicture}[scale=0.95]
    ...
    \node[align=center, font=\small] at (2.0, 1.6)
      {\textbf{Low sensitivity,}\\Low complexity:\\\tool{Claude} / \tool{GPT-4o}\\Chat};
...
\begin{frame}{Three Concrete Next Steps}
  \begin{enumerate}
    \item \textbf{Today:} Install \tool{Claude Code} or \tool{Cursor} and use it for your next coding task. Pay attention to where it helps and where it errs.
