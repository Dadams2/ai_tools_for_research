...
\begin{frame}{The Shift in How Code Gets Written}
  ...
  \begin{tikzpicture}[
    ...
    \node[event] (e4) at (10.2,0) {2024--25\\LLM-native IDEs\\agentic coding};
    ...
    \begin{column}{0.30\textwidth}
      \begin{block}{Chat-with-Codebase}
        \begin{itemize}
          ...
          \item \textit{Examples:} Cursor, Cody, Continue
        \end{itemize}
      \end{block}
    \end{column}
    \hfill
