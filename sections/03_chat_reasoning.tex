  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        ...
        \item \model{gpt-5.6-sol} (\texttt{max}): OpenAI's flagship reasoning configuration
        \item \model{claude-fable-5}: Anthropic's flagship general-release model
...
\begin{frame}[shrink=8]{Context Window as a Research Tool}
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        \item GPT-5.6 Sol: 1M tokens $\approx$ 30+ long papers
        \item Claude Fable 5: 1M+ tokens $\approx$ 30+ long papers
