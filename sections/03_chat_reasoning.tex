  ...
  \begin{columns}[T, onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Reasoning Models}
        ...
        Dramatically improves multi-step math and logic~\parencite{wei2022cot}. Models like \model{o3}, \model{gpt-5.3-codex}, and \model{claude-opus-4-6} do this natively.
      \end{block}
      \vspace{0.4em}
  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        ...
        \item \model{o3} / \model{gpt-5.3-codex}: OpenAI's reasoning and agentic coding models
        \item \model{claude-opus-4-6} extended thinking: configurable thinking budget
        \item \model{deepseek-v3.2}: open-weight reasoning model with competitive CoT
      \end{itemize}
    \end{column}
    \hfill
...
\begin{frame}[shrink=8]{Context Window as a Research Tool}
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        \item GPT-5 / GPT-5.3-Codex: 400K tokens $\approx$ 13--15 long papers
        \item Claude 4.6 Sonnet: 200K tokens (1M beta) $\approx$ 7--8 long papers
        \item Gemini 3.1 Pro: 1M tokens $\approx$ a whole library section
      \end{itemize}
    \end{column}
    \hfill
    \begin{column}{0.42\textwidth}
