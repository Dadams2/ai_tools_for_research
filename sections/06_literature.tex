...
\begin{frame}{The Discovery Problem}
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        \item arXiv: $>$2.4 million papers as of 2024; $\sim$15K new papers/month in CS alone
        \item PubMed: $>$36 million citations
...
for p in papers:
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{itemize}
        ...
        \item Rate limit: 100 req/5 min (unauthenticated); 10K/day with API key
