...
\begin{frame}{Security in Agentic Systems: Critical Risks}
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.48\textwidth}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{alertblock}{Best Mitigation Practice}
        Run agents in sandboxed containers (Docker/gVisor), require human-in-the-loop approvals for all write/external actions, clean system logs of any API files/secrets, and enforce strict execution constraints.
      \end{alertblock}
    \end{column}
  \end{columns}
\end{frame}
