  ...
  \begin{lstlisting}[language=json, numbers=none, basicstyle=\ttfamily\tiny, aboveskip=1pt, belowskip=2pt]
{
  ...
  Available models include \model{claude-fable-5}, \model{gpt-5.6-sol}, \model{gemini-3.1-pro}, and more.
\end{frame}
