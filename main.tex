...
%  Sections
% ===========================================================
\input{sections/01_software_dev}
\input{sections/02_model_landscape}
\input{sections/03_chat_reasoning}
\input{sections/04_coding_assistants}
\input{sections/05_agentic}
\input{sections/06_literature}
\input{sections/07_writing}
\input{sections/08_caveats}
...
\begin{frame}{Appendix: Detailed Model Comparison}
  \small
  \begin{tabularx}{\textwidth}{lYYYY}
    \toprule
    \textbf{Model} & \textbf{Context} & \textbf{Multimodal} & \textbf{API} & \textbf{Open weight} \\
    \midrule
    \model{claude-opus-4} & 200K & Vision & Yes & No \\
    \model{gpt-4o}        & 128K & Vision+Audio & Yes & No \\
    \model{gemini-1.5-pro} & 1M  & Vision+Audio & Yes & No \\
    \model{llama-3.1-405b} & 128K & Text & Via providers & Yes \\
    \model{mistral-large}  & 128K & Text & Yes & Partial \\
    \model{qwen2.5-72b}    & 128K & Vision & Via providers & Yes \\
    \model{deepseek-r1}    & 64K & Text & Yes & Yes \\
    \model{gemma-2-27b}    & 8K  & Text & Via providers & Yes \\
    \bottomrule
  \end{tabularx}
\end{frame}
...
\begin{frame}{Appendix: Prompt Engineering Reference}
  ...
  \begin{tabularx}{\textwidth}{lX}
    ...
    Chain-of-thought & \textit{``Think step by step. [Problem]''} \\
